...
// File contracts/OmarPunksDNA.sol

pragma solidity ^0.8.0;

contract OmarPunksDNA {
...
// File contracts/OmarPunks.sol

pragma solidity ^0.8.0;

contract OmarPunks is ERC721, ERC721Enumerable, OmarPunksDNA {
    ...
    constructor(uint256 _maxSupply) ERC721("OmarPunks", "PLPKS") {
        ...
        returns (string memory)
    {
        ...
        string memory jsonURI = Base64.encode(
            abi.encodePacked(
                ...
                '", "description": "Omar Punks are randomized Avataaars stored on chain to teach DApp development on Omar", "image": "',
                image,
                '"}'
            )
        );
